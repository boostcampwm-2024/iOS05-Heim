...
public protocol CustomTabBarViewDelegate: AnyObject {
  func didButtonTap(
    _ item: TabBarItem
  )
}

public final class CustomTabBarView: UIView {
  // MARK: - Properties
  ...
  private lazy var centerButton: UIButton = {
    ...
    button.addTarget(self, action: #selector(didCenterButtonTap), for: .touchUpInside)
    return button
  }()
  ...
  @objc private func didCenterButtonTap() {
